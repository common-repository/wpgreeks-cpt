...
use Wpgreekscpt\Api\SettingsApi;
use Wpgreekscpt\Base\BaseController;
use Wpgreekscpt\Api\CallBacks\AdminCallbacks;
use Wpgreekscpt\Api\CallBacks\TaxonomyCallbacks;
...
class CustomTaxonomyController extends BaseController
{
	...
	{
		if ( ! $this->wpgreeks_activated( 'taxonomy_manager' ) ) return;
		...
		$args = array(
			array(
				...
				'args' => array(
					'option_name' => 'wpgreeks_plugin_tax',
					'label_for' => 'taxonomy',
					'field_description' => 'The taxonomy name/slug. Used for various queries for taxonomy content.',
			...
			array(
				...
				'args' => array(
					...
					'field_description' => 'Whether the taxonomy can have parent-child relationships. "True" gives checkboxes, "False" gives text input.',
					'class' => 'ui-toggle',
					'array' => 'taxonomy'
				)
			),
			array(
				...
				'args' => array(
					...
					'field_description' => 'Whether to allow automatic creation of taxonomy columns on associated post-types.',
					'class' => 'ui-toggle',
					'array' => 'taxonomy'
				)
			),
